...
import org.fractalmicro.ui.IconCellRenderer;
...
public class DesktopIcons extends JList<Node> {
    ...
    private void installBehaviour() {
        ...
        im.put(KeyStroke.getKeyStroke(KeyEvent.VK_O, MainMenu.CMD), "open");
        im.put(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, MainMenu.CMD), "open");
        im.put(KeyStroke.getKeyStroke(KeyEvent.VK_I, MainMenu.CMD), "info");
        im.put(KeyStroke.getKeyStroke(KeyEvent.VK_BACK_SPACE, MainMenu.CMD), "trash");
